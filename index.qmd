...
The mean value of $\gamma$ is equal `r gamma.mean`, which is close to that of the extension model without incorporating stochastic volatility heteroskedasticity. The plot and histogram shown in [Figure 12: The plot and histogram of gamma (The extension with stochastic volatility model)].
...
The mean value of $\gamma$ is equal `r gamma.mean`, which is close to zero. The plot and histogram shown in [Figure 16: The plot and histogram of gamma (The extension model)] confirms that the draw oscillates around the mean.
...
The trace plot and histogram of the restricted variable in [Figure 17: The trace plot and histogram of B0 inverse (The extension model)] confirms that $B_{0}^{-1}$ shows $B_{11}$ as positive, $B_{21}$ and $B_{31}$ as negative, and $B_{66}$ as positive, consistent with the specified restrictions.
...
The mean value of $\gamma$ is equal `r gamma.mean`, which is close to zero. This value is also very similar to what it was before the author incorporated stochastic volatility, as shown in [Figure 23: The plot and histogram of gamma (The extension with stochastic volatility model)].
